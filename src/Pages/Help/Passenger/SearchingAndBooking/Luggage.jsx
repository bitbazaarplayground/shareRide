// src/Pages/Luggage.jsx
import { Helmet } from "react-helmet-async";
import HelpArticleLayout from "../../HelpArticleLayout";

const page = {
  title: "Luggage Guidelines — TabFair",
  description: "How luggage affects bookings and ride coordination.",
  canonical: "https://www.tabfair.com/help/passenger/luggage",
  ...
  return (
    <>
      ...
      >
        <ul>
          <li>
            When posting or joining a ride, you must specify the amount of
            luggage you’ll bring.
          </li>
          <li>
          ...
          <li>
            Fair distribution helps split costs evenly among participants.
          </li>
        </ul>
        <p style={{ marginTop: "1.5rem", fontWeight: "500", color: "#cc0000" }}>
          ⚠️ Please note: If you bring more passengers or luggage than declared,
          the ride host or taxi provider may deny you access to the ride. In
          such cases, Tabfair is not responsible, and you may still be liable
          for your share of the ride fare.
        </p>
      </HelpArticleLayout>
    </>
  );
