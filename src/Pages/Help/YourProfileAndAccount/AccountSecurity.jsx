  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          Contact <Link to="/help/contact">Support</Link> so we can help secure
          your account.
        </li>
      </ul>
      ...
      <p>
        ShareRide uses industry-standard encryption to protect all user data. We
        never share your personal information without your consent, and access
        to your data is restricted to authorized personnel only.
      </p>
      <p>
