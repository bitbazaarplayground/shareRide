  ...
  return (
    <div className="help-wrapper">
      ...
      <header className="help-header">
        ...
        <p className="subtext">
          Learn how to keep your ShareRide account safe and secure.
        </p>
      </header>
